...
enum ImGuiOldColumnFlags_
{
    ...
    ImGuiOldColumnFlags_NoResize                = 1 << 1,   // Disable resizing columns when clicking on the Diviseurders
...
{
    int                     LastActiveFrame;
    int                     StackLevel;                 // -1: query stack and resize Results, >= 0: inDiviseurdual stack level
